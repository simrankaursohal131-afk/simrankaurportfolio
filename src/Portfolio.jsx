...
const skills = [
  { icon:"🎨", name:"Canva", desc:"Visual content design and brand template creation" },
  { icon:"📱", name:"Social Media", desc:"Content coordination across fashion platforms" },
  { icon:"📣", name:"PR Support", desc:"Press coordination and brand communication" },
  { icon:"⚙️", name:"Creative Ops", desc:"Workflow architecture and process management" },
  { icon:"📋", name:"Workflow Mgmt", desc:"Systematic delivery frameworks for teams" },
  { icon:"🗂️", name:"Admin Support", desc:"Executive-level coordination and scheduling" },
  { icon:"🗓️", name:"Scheduling", desc:"Calendar management and deadline tracking" },
  { icon:"🤝", name:"Client Coord.", desc:"Client communication and relationship support" },
  { icon:"💾", name:"Digital Assets", desc:"Organised file systems and asset libraries" },
  { icon:"✨", name:"Brand Support", desc:"Consistency across visual and tone identity" },
  { icon:"💬", name:"Communication", desc:"Polished written and verbal correspondence" },
  { icon:"🌐", name:"Remote Collab", desc:"Seamless async collaboration across time zones" },
];
    ...
    <div data-theme={dark ? "dark" : "light"}>
      ...
      <nav className={`nav${navScrolled ? " scrolled" : ""}`}>
        ...
        <ul className="nav-links">
          {[["About","about"],["Experience","experience"],["Skills","skills"],["Work","projects"],["Testimonials","testimonials"],["Contact","contact"]].map(([label, id]) => (
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-title">Creative Operations · Brand Support · Social Media & PR</p>
          <div className="hero-line" />
          <p className="hero-intro">Creative operations and brand support professional with five years of experience in fashion, lifestyle, social media coordination, and remote workflow management.</p>
      ...
      <footer>
        ...
        <div className="footer-links">
          {[["Work","projects"],["About","about"],["Contact","contact"]].map(([lbl,id]) => (
